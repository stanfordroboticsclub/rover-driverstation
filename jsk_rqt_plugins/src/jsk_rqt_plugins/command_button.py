...
from python_qt_binding.QtWidgets import (QAction, QSizePolicy, QDialog, QMenu, QWidget, QMessageBox, QComboBox, QLineEdit, QCompleter, QPushButton) 
...
class CommandButtonGeneralWidget(QWidget):
    """
    Qt widget to visualize multiple buttons
    """
    def __init__(self, button_type = "push"):
        super(CommandButtonGeneralWidget, self).__init__()
    ...
    def buttonCallback(self, command):
        """
